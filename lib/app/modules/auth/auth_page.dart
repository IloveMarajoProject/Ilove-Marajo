...
import 'package:ilovemarajo/app/modules/auth/widgets/container_liquid.dart';
import 'package:ilovemarajo/app/modules/auth/widgets/container_liquid_final.dart';
...
class _LiquidPage extends State<AuthPage> {
  ...
  List<ItemData> data = [
    ItemData(
        Colors.blue, "image/ilha2.png", "Olá", "Bem vindo ao ", "Ilove Marajó"),
    ItemData(Colors.purple, "image/ilha.png", "Encontre os melhores",
        "Pontos turisticos", "do Marajó aqui"),
    ItemData(Colors.cyan, "image/fundos/bufalo.png", "Liked?", "Fork!",
        "Give Star!"),
  ];
