...
import 'package:ilovemarajo/app/modules/initial/controller/initial_controller.dart';
import 'package:ilovemarajo/app/modules/initial/models/municipio.dart';
import 'package:ilovemarajo/app/modules/initial/widgets/municipios_nome.dart';
...
class _InitialPageState extends State<InitialPage> {
  ...
  _pegarMunicipios() async {
    try {
      await _controller.pegarDadosMunicipio();
    } catch (e) {
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: StreamBuilder<List<MunicipioModel>>(
                                stream: _controller.dados.stream,
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return NomesMunicipios(dados[index]);
                                    },
                                  );
                                }))
                      ],
